...
function Key({ size = "", accent = "" }: { size?: string; accent?: string }) {
  ...
  return (
    <div className={`tk-key tk-flex${size ? ` tk-key${s}` : ""}`}>
      <div
        className={`tk-key__front tk-face${size ? ` tk-key__front${s}` : ""}${
          a1 === " tk-face--b"
            ? " tk-face--b3"
            : a1 === " tk-face--o"
              ? " tk-face--o3"
      ...
      />
      <div
        className={`tk-key__back tk-face${size ? ` tk-key__back${s}` : ""}${
          a1 === " tk-face--b"
            ? " tk-face--b1"
            : a1 === " tk-face--o"
              ? " tk-face--o1"
      ...
      />
      <div
        className={`tk-key__right tk-face${size ? ` tk-key__right${s}` : ""}${
          a1 === " tk-face--b"
            ? " tk-face--b1"
            : a1 === " tk-face--o"
              ? " tk-face--o1"
      ...
      />
      <div
        className={`tk-key__left tk-face${size ? ` tk-key__left${s}` : ""}${
          a1 === " tk-face--b"
            ? " tk-face--b2"
            : a1 === " tk-face--o"
              ? " tk-face--o2"
      ...
      />
      <div
        className={`tk-key__top tk-face${size ? ` tk-key__top${s}` : ""}${
          a1 === " tk-face--b"
            ? " tk-face--b1"
            : a1 === " tk-face--o"
              ? " tk-face--o1"
      ...
      />
      <div
        className={`tk-key__bottom tk-face${size ? ` tk-key__bottom${s}` : ""}${
          a1 === " tk-face--b"
            ? " tk-face--b2"
            : a1 === " tk-face--o"
              ? " tk-face--o2"
  ...
  useEffect(() => {
    ...
    const typeNext = () => {
      ...
      if (idx >= autoTypeText.length) {
        ...
        const delay =
          typingSpeed[0] + Math.random() * (typingSpeed[1] - typingSpeed[0]);
    ...
    <div className={cn("tk-container", className)} {...props}>
      <style>{`
        ...
        @media (min-width: 768px) {
          .tk-main {
            transform: translateY(52px) scale(${scale});
          }
        }
          ...
          <div className="tk-keyboard__top tk-face">
            ...
            <div className="tk-keys">
              ...
              {Array.from({ length: 2 }).map((_, i) => (
                <Key key={`r5a-${i}`} accent="b" />
              ))}
              <Key size="w6" />
              {Array.from({ length: 5 }).map((_, i) => (
                <Key key={`r5b-${i}`} accent="b" />
              ))}
            </div>
          </div>
